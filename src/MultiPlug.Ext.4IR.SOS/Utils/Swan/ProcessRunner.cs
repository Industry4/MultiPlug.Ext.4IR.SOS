...
/// </summary>
namespace MultiPlug.Ext._4IR.SOS.Utils.Swan
{
    using System;
    ...
    internal static class ProcessRunner
    {
        ...
        internal delegate void ProcessDataReceivedCallback(byte[] processData, Process process);
        ...
        /// </code>
        /// </example>
        internal static async Task<string> GetProcessOutputAsync(
            string filename,
            string arguments = "",
        ...
        /// </returns>
        internal static async Task<string> GetProcessEncodedOutputAsync(
            string filename,
            string arguments = "",
        ...
        internal static Task<ProcessResult> GetProcessResultAsync(
            string filename,
            string arguments = "",
            CancellationToken cancellationToken = new CancellationToken()) =>
        ...
        /// }
        /// </code></example>
        internal static async Task<ProcessResult> GetProcessResultAsync(
            string filename,
            string arguments,
            string workingDirectory,
            Encoding encoding = null,
        ...
        /// </returns>
        internal static Task<int> RunProcessAsync(
            string filename,
            string arguments,
            string workingDirectory,
